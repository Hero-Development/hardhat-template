...
(async () => {
  try {
    ...
    const web3 = new Web3( `https://sepolia.base.org` );
		const account = web3.eth.accounts.privateKeyToAccount(env.ACCOUNTS.xxx.PK);
     ...
     * SETTINGS
     **/
    const baseFee              = Web3.utils.toWei('0.1', 'gwei');
